...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.control_button_grid = QGridLayout()
        self.left_grid.addLayout(self.control_button_grid, 1, 2)
        self.set_flight_mode_button = QPushButton('Set Mode')
        self.control_button_grid.addWidget(self.set_flight_mode_button, 1, 1)
        self.set_destination_button = QPushButton('Set Destination')
        self.control_button_grid.addWidget(self.set_destination_button, 2, 1)
        self.set_direction_button = QPushButton('Set Direction')
        self.control_button_grid.addWidget(self.set_direction_button, 3, 1)
        self.set_antena_loactio_button =  QPushButton('SET ANTENA LOCATION')
        self.control_button_grid.addWidget(self.set_antena_loactio_button, 4, 1)
        self.plot1 = Plot()
        ...
        self.text_grid.addWidget(self.find_point_button, 1, 2)
